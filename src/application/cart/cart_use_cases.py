...
from src.domain.cart.cart import ArticuloCarrito, Carrito
from src.domain.cart.cart_repository import IRepositorioCarrito
from src.domain.catalog.catalog import VariacionProducto
from src.domain.catalog.catalog_repository import ICatalogRepository
from src.domain.catalog.product import ProductoBien
